...
expected_cluster="helixworks-forge-$environment"
...
kubectl --context "$context" -n helixworks-forge get secret control-plane-secrets generator-secrets runtime-secrets evidence-secrets -o json \
